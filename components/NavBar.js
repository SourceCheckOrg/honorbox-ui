          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex items-center md:hidden">
                <button
                  type="button"
                  className="inline-flex items-center justify-center p-0 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
              ...
              <div className="flex-shrink-0 flex items-center ml-3 md:ml-0">
                <Link href="/">
                  <a className="text-white text-2xl font-thin widest mr-8">HonorBox</a>
                </Link>
              </div>
