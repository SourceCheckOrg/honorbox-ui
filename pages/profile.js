                ...
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                  <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <div className="col-span-6 sm:col-span-4">
                      <label htmlFor="username" className="block text-sm font-medium text-gray-700">Username (for internal reference only)</label>
                      <input 
                        type="text" 
                        name="username" 
                        value={user.username}
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      <label htmlFor="email" className="block text-sm font-medium text-gray-700">Verified Email Address</label>
                      <input
                        type="text" 
                        name="email" 
                        value={user.email}
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      <label htmlFor="did" className="block text-sm font-medium text-gray-700">Wallet ID (aka 'DID')</label>
                      <input 
                        type="text" 
                        name="did" 
                        value={user.did}
              ...
              <div className="mt-5 md:mt-0 md:col-span-2">
                <form onSubmit={onSubmit}>
                  <div className="shadow sm:rounded-md sm:overflow-hidden">
                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="name" className="block text-sm font-medium text-gray-700">Publisher Username (Public-facing)</label>
                        <input 
                          type="text" 
                          name="name" 
                          value={name}
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="slug" className="block text-sm font-medium text-gray-700">Root directory for permanent, public URLs (aka 'slug')</label>
                        <input 
                          type="text" 
                          name="slug" 
                          value={slug}
